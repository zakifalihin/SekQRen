            ...
            <div class="table-responsive">
                ...
                <div class="d-flex justify-content-center mt-3">
                    ...
                    @if($siswa->onFirstPage())
                        <button class="btn btn-secondary mx-2" disabled>Prev</button>
                    @else
                        <a href="{{ $siswa->previousPageUrl() }}" class="btn btn-primary mx-2">
                            Prev
                        </a>
                    @endif
                    ...
                    @if($siswa->hasMorePages())
                        <a href="{{ $siswa->nextPageUrl() }}" class="btn btn-primary mx-2">
                            Next
                        </a>
                    @else
